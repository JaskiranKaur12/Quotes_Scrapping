...
class QuotesPage:
    ...
    def quotes(self) -> List[QuoteParser]:
        ...
        all_quotes= self.browser.find_elements_by_css_selector(locator)
    ...
    def search_for_quotes(self,author_name:str, tag_name:str)-> List[QuoteParser]:
         ...
         #Alternative way- time.sleep(10)- it will hold for 10 seconds irrespective of how long the search takes
         try:
